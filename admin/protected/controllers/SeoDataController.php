...
class SeoDataController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['SeoData']))
		{
			...
			if($model->save())
			{
				Yii::app()->user->setFlash('success','Record Created Successfully');
	...
	{
		$dataProvider=new CActiveDataProvider('SeoData');
	 ...
	 * @param SeoData $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='seo-data-form')
		{
