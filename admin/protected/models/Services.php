...
class Services extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title, created_at, active', 'required'),
			...
			array('id, title,  description, created_at, active', 'safe', 'on'=>'search'),
		);
	}
	...
	{
			$criteria = new CDbCriteria;
			$criteria = array('order'=> 'sort ASC'); 	
			$service = Services::model()->findAll($criteria);	
		    $service_list = CHtml::listData($service, 'id', 'title');
		    return $service_list;
	}
}
