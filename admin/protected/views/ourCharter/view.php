<?php 
$this->pageTitle="View Our Charter";
$this->breadcrumbs=array(
	'Our Charter'=>array('admin'),

);
$ext = explode(".",$model->banner);
				$ext = end($ext);				
				$filen=$model->id."-ourcharter.".$ext;
				$path=Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/charter/'.$filen; 
				
				$ext1 = explode(".",$model->image);
				$ext1= end($ext1);				
				$filen1=$model->id."-ourcharter-image.".$ext1;
				$imagepath=Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/charter/'.$filen1; 
?>
