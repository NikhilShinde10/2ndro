...
<?php  $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php 
				...
				$path=Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/charter/'.$model->banner; 			
	...
	<div class="row">
		...
		<?php 
				...
				$ext1 = end($ext1);
				$filen1=$model->id."-ourcharter-image.".$ext;
				$path1=Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/charter/'.$model->image; 			
