...
<?php  $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php 
				...
				$ext = end($ext);
				$filen=$model->id."-WhyUs.".$ext;
				$path=Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/WhyUs/'.$model->banner; 			
	...
	<div class="row">
		...
		<?php 
				...
				$ext1 = end($ext1);
				$filen1=$model->id."-WhyUs-image.".$ext;
				$path1=Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/WhyUs/'.$model->image; 			
...
<script>
CKEDITOR.replace('WhyUs_block1',
            {   toolbar:'MA'    }
         );

		 CKEDITOR.replace('WhyUs_block2',
            {   toolbar:'MA'    }
         );
</script>
