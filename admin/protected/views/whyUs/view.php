...
$ext = explode(".",$model->banner);
				...
				$path=Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/WhyUs/'.$filen; 
				
				$ext1 = explode(".",$model->image);
				$ext1= end($ext1);				
				$filen1=$model->id."-WhyUs-image.".$ext1;
				$imagepath=Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/WhyUs/'.$filen1; 
?>
