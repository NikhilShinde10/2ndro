	...
	<?php 
		if($model->logo!="")
		{
			echo "<div class='row'>
					...
					echo CHtml::image(Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/setting/'.$model->logo,' ', array('class'=>'gimg'));
					echo "</div></div>";
	...
	<div class="row">
		...
		if($model->home_slider_image!="")
		{
			echo "<div class='row'>
					...
					echo CHtml::image(Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/setting/'.$model->home_slider_image,' ', array('class'=>'gimg'));
					echo "</div></div>";
	...
	<?php 
		if($model->home_slider_image1!="")
		{
			echo "<div class='row'>
					...
					echo CHtml::image(Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/setting/'.$model->home_slider_image1,' ', array('class'=>'gimg'));
					echo "</div></div>";
	...
	<?php 
		if($model->about_area_image!="")
		{
			echo "<div class='row'>
					...
					echo CHtml::image(Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/setting/'.$model->about_area_image,' ', array('class'=>'gimg'));
					echo "</div></div>";
...
<?php 
		if($model->service_image!="")
		{
			echo "<div class='row'>
					...
					echo CHtml::image(Yii::app()->baseurl.DIRECTORY_SEPARATOR.'uploads/setting/'.$model->service_image,' ', array('class'=>'gimg'));
					echo "</div></div>";
