...
$(function () {
    ...
    $('.bg-img').each(function () {
        ...
        $(this).parent().css({
            'background-image': 'linear-gradient(90deg, rgba(255, 255, 255, 1) 40%, rgba(0, 0, 0, 0) 50%)'+','+'url(' + imgSrc + ')',
    ...
    function closePopupFromOutside(popup, stopPropogationElement, popupTriggerBtn, removedClass, addedClass) {
        $(popupTriggerBtn).on('click', function () {
    ...
    openPopup('.action__btn-play-video-1', '.play-video-1-popup', 'active', 'inActive') // Open sidenav popup
    closePopup('.play-video-1-popup__close', '.play-video-1-popup', 'active', 'inActive') // Close sidenav popup
    ...
    closePopupFromOutside('#login-popup', '.login-popup-wrapper', '.close-login-popup', 'active', 'inActive');  // close popup when clicking on an other place on the Document
